#!/usr/bin/env python3
"""
Batch import all MiNi cups from .claude/txts/mini3.txt

Usage:
    python batch_import_mini3.py          # Import all
    python batch_import_mini3.py --dry    # Dry run - list tdids only
"""
import sys
import os
import json
...
TXT_FILE = os.path.join(os.path.dirname(__file__) or '.', '.claude', 'txts', 'mini3.txt')
