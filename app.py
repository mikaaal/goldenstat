...
@app.route('/tournaments/match')
def tournaments_match_page():
    """Tournament match detail page"""
    return render_template('tournaments.html', cups_active=True)

@app.route('/tournaments/players')
...
@app.route('/api/tournaments/match/<int:mid>')
...
@app.route('/api/tournaments/players')
...
@app.route('/api/tournaments/player/<player_name>')
